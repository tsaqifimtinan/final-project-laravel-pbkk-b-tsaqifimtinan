...
import ManagePrescriptions from '@/Pages/Prescription/ManagePrescriptions.vue'; // Import the new component
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-4 gap-4">
                    ...
                    <div class="col-span-3 bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                        <!-- Replace Welcome component with ManagePrescriptions component -->
                        <ManagePrescriptions />
                    </div>
                </div>
            </div>
