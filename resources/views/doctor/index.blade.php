    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col">
                    <div class="w-100">
                        <form action="{{ route('doctor.index') }}" class="w-100" method="GET" class="form-inline mb-4">
                            <div class="row gap-2">
                                <div class="col col-12 col-md-6">
                                    <div class="input-group flex-grow-1">
                                        <input type="text" name="search" class="form-control" id="search"
                                            placeholder="id, name, specialization, department etc."
                ...
                @foreach ($data['doctors'] as $doctor)
                    <div class="col">
                        <div class="card overflow-auto position-relative">
                            <div class="card-body">
                                <h5 class="card-title"><b>{{ $doctor->name }}</b></h5><br>
